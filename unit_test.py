...
class TestSort(unittest.TestCase):
    def test_sort(self):
        ...
        self.assertEqual(sort([22]), [22])
        
        # Тест на массиве из нескольких элементов
        self.assertEqual(sort([64, 34, 25, 12, 22, 11, 90]), [11, 12, 22, 25, 34, 64, 90])
        
        # Тест на массиве с отрицательными числами
        self.assertEqual(sort([-5, -1, -3, -2, -4]), [-5, -4, -3, -2, -1])
        
        # Тест на массиве с повторяющимися элементами
        self.assertEqual(sort([5, 3, 5, 2, 8, 2]), [2, 2, 3, 5, 5, 8])
